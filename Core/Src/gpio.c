...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, COL0_Pin|SPI_FLASH_CS_Pin|LCD_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_Pin|TP_RST_Pin|COL2_Pin|LCD_CS_Pin
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SD_CARD_DET_GPIO_Port, SD_CARD_DET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : COL0_Pin SPI_FLASH_CS_Pin LCD_RST_Pin */
  GPIO_InitStruct.Pin = COL0_Pin|SPI_FLASH_CS_Pin|LCD_RST_Pin;
  ...
  /*Configure GPIO pins : KEY3_Pin ROW1_Pin */
  GPIO_InitStruct.Pin = KEY3_Pin|ROW1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : LED_Pin TP_RST_Pin COL2_Pin LCD_CS_Pin
                           LCD_DC_Pin */
  GPIO_InitStruct.Pin = LED_Pin|TP_RST_Pin|COL2_Pin|LCD_CS_Pin
                          |LCD_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : EC11_B_Pin ROW0_Pin */
  GPIO_InitStruct.Pin = EC11_B_Pin|ROW0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
