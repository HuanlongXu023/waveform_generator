...
// #define LCD_RST_SET GPIOE->BSRR = 1 << 1 // 复位  	    	 PC15
...
// #define LCD_RST_CLR GPIOE>BRR = 1 << 1 // 复位  	    		 PC15
...
#define ST7789_RAM *(__IO uint16_t *)(((uint32_t)0x60000000) + (1 << 17)) // A16 右移1位
